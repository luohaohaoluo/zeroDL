...
from networks.frcnn_training import FasterRCNNTrainer, get_lr_scheduler, set_optimizer_lr, weights_init

from utils.callbacks import EvalCallback, LossHistory
from utils.dataloader import FRCNNDataset, frcnn_dataset_collate
from utils.utilss import get_classes, seed_everything, show_config, worker_init_fn
...
if __name__ == "__main__":
    ...
    if model_path != '':
        ...
        # 使用了 ANSI 转义序列来在终端中打印带有颜色和样式的提示信息
    ...
    if True:
        ...
        #   Init_lr_fit ~ (lr_limit_min,lr_limit_max)
        #   Min_lr_fit  ~ (lr_limit_min* 1e-2,lr_limit_max * 1e-2)
        # -------------------------------------------------------------------#
        nbs = 16
